...
assert 'All Categories' in Path("Plugins/Extensions/Enigma2UniversalPanel/screens.py").read_text()
assert 'open_category_selector' in Path("Plugins/Extensions/Enigma2UniversalPanel/screens.py").read_text()
assert '_category_selected' in Path("Plugins/Extensions/Enigma2UniversalPanel/screens.py").read_text()
...
assert 'Panel v1.8.0' in Path("Plugins/Extensions/Enigma2UniversalPanel/screens.py").read_text()
